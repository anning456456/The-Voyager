...
namespace Voyage
{
    public static class SoundExtension
    {
        ...
        public static int? PlayMusic(this SoundComponent soundComponent, int musicId, object userData = null)
        {
            ...
            IDataTable<DRMusic> dtMusic = Game.DataTable.GetDataTable<DRMusic>();
        ...
        public static int? PlaySound(this SoundComponent soundComponent, int soundId, FrameworkExtension.Entity bindingEntity = null, object userData = null)
        {
            IDataTable<DRSound> dtSound = Game.DataTable.GetDataTable<DRSound>();
        ...
        {
            IDataTable<DRUISound> dtUISound = Game.DataTable.GetDataTable<DRUISound>();
        ...
        public static void Mute(this SoundComponent soundComponent, string soundGroupName, bool mute)
        {
            ...
            Game.Setting.SetBool(Utility.Text.Format(Constant.Setting.SoundGroupMuted, soundGroupName), mute);
            Game.Setting.Save();
        }
        ...
        public static void SetVolume(this SoundComponent soundComponent, string soundGroupName, float volume)
        {
            ...
            Game.Setting.SetFloat(Utility.Text.Format(Constant.Setting.SoundGroupVolume, soundGroupName), volume);
            Game.Setting.Save();
        }
    }
}
